        ...
        <div class="container max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[2fr_3fr] gap-8 md:gap-20 items-center">
            <section class="bg-white rounded-3xl p-8 sm:p-12 w-full max-w-xl mx-auto shadow-xl">
                ...
                <div class="flex space-x-2 bg-gray-100 p-1 rounded-xl mb-8">
                    <button type="button" :class="{ 'bg-white shadow-sm text-[#0065B3]': isAdmin, 'text-gray-500 hover:bg-white/50': !isAdmin }" @click="updateRole(true)" class="flex-1 flex items-center justify-center py-2 px-4 rounded-lg transition font-semibold">
                        <i class="material-icons text-lg mr-2">admin_panel_settings</i>
                        <span>Admin</span>
                    </button>
                    <button type="button" :class="{ 'bg-white shadow-sm text-[#0065B3]': !isAdmin, 'text-gray-500 hover:bg-white/50': isAdmin }" @click="updateRole(false)" class="flex-1 flex items-center justify-center py-2 px-4 rounded-lg transition font-semibold">
                ...
                <form class="space-y-6" @submit.prevent="submit">
                    <div>
                        ...
                        <div class="relative">
                            <input id="email" v-model="form.email" type="email" :placeholder="emailPlaceholder" class="w-full pl-10 pr-4 py-3 rounded-xl bg-blue-50 text-sm font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-600" required autofocus autocomplete="username" />
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input :type="showPassword ? 'text' : 'password'"
                                   ...
                                   class="w-full pl-10 pr-10 py-3 rounded-xl bg-blue-50 text-sm font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-600"
                                   required
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <Link v-if="canResetPassword" :href="route('password.request')" class="text-sm text-blue-600 hover:underline">Lupa password?</Link>
                    </div>
                ...
                <p class="mt-8 text-center text-sm text-gray-500">
                    Belum punya akun?
                    <Link :href="route('register')" class="font-semibold text-blue-600 hover:underline">
                        Daftar sekarang
                    </Link>
                </p>
            </section>
