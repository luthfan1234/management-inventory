...
// Halaman "Lupa Kata Sandi" disesuaikan dengan layout halaman Login.
    ...
    <div class="bg-gray-100 min-h-screen flex items-center justify-center px-4 py-6 md:px-10">
        <div class="container max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[2fr_3fr] gap-8 md:gap-20 items-center">
            ...
            <section class="bg-white rounded-3xl p-8 sm:p-12 w-full max-w-xl mx-auto shadow-xl">
                ...
                <h2 class="text-xl font-bold mb-1 text-center text-gray-900">Lupa Kata Sandi Anda?</h2>
                <p class="text-center text-gray-500 mb-8">
                    Masukkan email Anda dan kami akan mengirimkan tautan untuk mengatur ulang kata sandi.
                </p>

                <form @submit.prevent="submit">
                    <div v-if="status" class="mb-4 p-4 text-sm bg-green-100 text-green-800 border border-green-200 rounded-lg">
                        {{ status }}
                    </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="relative">
                                <input id="email" type="email" v-model="form.email" placeholder="Masukan alamat email" class="w-full pl-10 pr-4 py-3 rounded-xl bg-blue-50 text-sm font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-600" required autofocus autocomplete="username" />
                        ...
                        <button type="submit" class="w-full bg-blue-600 text-white rounded-xl py-3 font-semibold hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 transition" :class="{ 'opacity-50': form.processing }" :disabled="form.processing">
                            Kirim Tautan Reset
                        </button>
                    </div>
